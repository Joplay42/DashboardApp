...
import Home from "./Home/Home"; // Components imports
import CreateNote from "./Create/CreateNote"; // Components imports
import Settings from "./Settings/Settings"; // Components imports
  ...
  return (
    <div className="flex lg:grid lg:grid-cols-4">
      ...
      <div className="w-full lg:col-span-3">
        {index == 0 && <Home index={setIndex} />}
        {index == 1 && <CreateNote index={setIndex} />}
        {index == 2 && <Settings />}
      </div>
    </div>
  );
